...
export const HomeView: FC = ({}) => {
  ...
  return (
    <>
      <ViewHeading>
        HOLD ${TOKEN_TICKER}, EARN ${REWARD_TICKER}!
      </ViewHeading>
      <Button variant="outline" disabled href="/holdings" className="">
        CURRENT HOLDINGS
      </Button>
      <Button variant="outline" disabled href="/earnings" className=" ">
        CURRENT EARNINGS
      </Button>
      <Button
        variant="arrow"
        href="https://docs.stablesolana.com/"
        className=" "
      >
        DOCUMENTATION
      </Button>
